...
public class ServiceItemAdapterHistory extends RecyclerView.Adapter<ServiceItemViewHolderHistory> {
    ...
    public ServiceItemAdapterHistory(Context context, List<ServiceItem> list) {
    ...
    @NonNull
    @Override
    public ServiceItemViewHolderHistory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ServiceItemViewHolderHistory(LayoutInflater.from(context).inflate(R.layout.service_item_recycler_view_history, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull ServiceItemViewHolderHistory holder, int position) {
